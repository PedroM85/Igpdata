...
class Cupload extends CI_Controller
{
    ...
    public function subirImagen(){
        $config['upload_path'] = base_url().'uploads/imagenes/';
    ...
    function crearMiniatura($filename){
        ...
        $config['source_imagen'] = 'uploads/imagenes/'.$filemane;
        $config['create_thumb'] = true;
        $config['maintain_ratio'] = true;
        $config['new_imagen'] = 'uploads/imagenes/thumbs/';
        $config['thumb_marker'] = '';
        $config['width'] = 150;
        $config['heigth'] = 150;
    ...
    public function subirArchivo(){
        $config['upload_path'] = base_url().'uploads/archivos/';
